...
/**
 *  | Perceptually uniform color scales from matplotlib.
 *  |
 *  | See: https://github.com/BIDS/colormap
 */
"use strict";
 ...
 */
var viridis = Partial_Unsafe.unsafePartial(function (dictPartial) {
    return matplotlibScale(dictPartial)(_viridis_data);
});
 ...
 */
var plasma = Partial_Unsafe.unsafePartial(function (dictPartial) {
    return matplotlibScale(dictPartial)(_plasma_data);
});

/**
 *  The following array are 1:1 copies from
 ...
 */
var magma = Partial_Unsafe.unsafePartial(function (dictPartial) {
    return matplotlibScale(dictPartial)(_magma_data);
});
 ...
 */
var inferno = Partial_Unsafe.unsafePartial(function (dictPartial) {
    return matplotlibScale(dictPartial)(_inferno_data);
});
module.exports = {
    inferno: inferno, 
    magma: magma, 
