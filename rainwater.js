 ...
 */  
  var SurfaceArea = (function () {
      function SurfaceArea(value0) {
          this.value0 = value0;
      };
      SurfaceArea.create = function (value0) {
          return new SurfaceArea(value0);
      };
      return SurfaceArea;
  })();
 ...
 *  model for the event sourcing
 */  
  var FoodSharing = (function () {
      function FoodSharing() {

      };
      FoodSharing.value = new FoodSharing();
      return FoodSharing;
  })();
 ...
 *  model for the event sourcing
 */  
  var FoodGardening = (function () {
      function FoodGardening() {

      };
      FoodGardening.value = new FoodGardening();
      return FoodGardening;
  })();

  /**
 *  model for the event sourcing
 */  
  var RainwaterCollecting = (function () {
      function RainwaterCollecting() {

      };
      RainwaterCollecting.value = new RainwaterCollecting();
      return RainwaterCollecting;
  })();
 ...
 *  model for the event sourcing
 */  
  var TapWaterSupplying = (function () {
      function TapWaterSupplying() {

      };
      TapWaterSupplying.value = new TapWaterSupplying();
      return TapWaterSupplying;
  })();
 ...
 */  
  ...
  var EatingBinningWormCompostingFoodGardening = (function () {
      function EatingBinningWormCompostingFoodGardening() {

      };
      EatingBinningWormCompostingFoodGardening.value = new EatingBinningWormCompostingFoodGardening();
      return EatingBinningWormCompostingFoodGardening;
  })();
  ...
  var EatingBinningFoodSharing = (function () {
      function EatingBinningFoodSharing() {

      };
      EatingBinningFoodSharing.value = new EatingBinningFoodSharing();
      return EatingBinningFoodSharing;
  })();
  ...
  var TapWater = (function () {
      function TapWater() {

      };
      TapWater.value = new TapWater();
      return TapWater;
  })();
  ...
  var Fertilizer = (function () {
      ...
      Fertilizer.value = new Fertilizer();
      return Fertilizer;
  })();
  var GreenhouseGas = (function () {
      function GreenhouseGas() {

      };
      GreenhouseGas.value = new GreenhouseGas();
  ...
  var toVolume = function (v) {
      return function (v1) {
          if (v1 instanceof Weight) {
              return Volume.create(v1.value0)(v1.value1 / v);
          };
          ...
          throw new Error("Failed pattern match at Calculator.Model line 156, column 1 - line 156, column 63: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var showQuantity = function (dictShow) {
      return new Data_Show.Show(function (v) {
          if (v instanceof Weight && v.value1 >= 1000.0) {
              return Data_Show.show(Data_Show.showNumber)($$Math.trunc(v.value1 * 1.0) / 1000.0) + " Tons";
          };
          if (v instanceof Weight) {
              return Data_Show.show(Data_Show.showNumber)($$Math.trunc(v.value1 * 10.0) / 10.0) + "Kg";
          };
          if (v instanceof Volume) {
              return Data_Show.show(Data_Show.showNumber)($$Math.trunc(v.value1 * 10.0) / 10.0) + "L";
          };
          ...
          throw new Error("Failed pattern match at Calculator.Model line 281, column 5 - line 282, column 5: " + [ v.constructor.name ]);
      });
  };
  var scaleQtyOnTime = function (v) {
      return function (q) {
          var timeFactor = (function () {
              ...
              throw new Error("Failed pattern match at Calculator.Model line 675, column 18 - line 679, column 5: " + [ v.time.constructor.name ]);
          })();
          var applyFactor = function (qty) {
              return timeFactor * qty;
          };
          var scaleQ = function (v1) {
              if (v1 instanceof Weight) {
                  return new Weight(v1.value0, applyFactor(v1.value1));
              };
              if (v1 instanceof Volume) {
                  return new Volume(v1.value0, applyFactor(v1.value1));
              };
              if (v1 instanceof ZeroQuantity) {
                  return ZeroQuantity.value;
              };
              ...
              throw new Error("Failed pattern match at Calculator.Model line 672, column 1 - line 683, column 55: " + [ v1.constructor.name ]);
          };
          return scaleQ(q);
      };
  };
      ...
      return function (v1) {
          return function (q) {
              var timeFactor = (function () {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 661, column 22 - line 665, column 9: " + [ v.time.constructor.name ]);
              })();
              var scaleFactor = (function () {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 657, column 23 - line 660, column 51: " + [ v.scale.constructor.name ]);
              })();
              ...
              var scaleQ = function (v2) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 655, column 1 - line 669, column 59: " + [ v2.constructor.name ]);
              };
              return scaleQ(q);
          };
      };
  };
  var scaleNumberOnTime = function (v) {
      return function (n) {
          var timeFactor = (function () {
              if (v.time instanceof Day) {
                  return 1.0 / 365.25;
              ...
              throw new Error("Failed pattern match at Calculator.Model line 689, column 18 - line 695, column 1: " + [ v.time.constructor.name ]);
          })();
          return timeFactor * n;
      };
  };
  var scaleFirstEntry = function (systemScale) {
      return function (systemParams) {
          return function (v) {
              return State.create((function () {
                  var $162 = Data_Array.uncons(v.value0);
                  if ($162 instanceof Data_Maybe.Nothing) {
                      return [  ];
                  };
                  if ($162 instanceof Data_Maybe.Just) {
                      return Data_Array.cons(Entry.create((function () {
                          var $164 = {};
                          for (var $165 in $162.value0.head.value0) {
                              if ($162.value0.head.value0.hasOwnProperty($165)) {
                                  $164[$165] = $162.value0.head.value0[$165];
                              };
                          };
                          $164.quantity = scaleQty(systemScale)(systemParams)($162.value0.head.value0.quantity);
                          return $164;
                      })()))($162.value0.tail);
                  };
                  throw new Error("Failed pattern match at Calculator.Model line 707, column 3 - line 710, column 138: " + [ $162.constructor.name ]);
              })());
          };
      };
  };
  var rangeScale = function (v) {
      return function (v1) {
          return function (v2) {
              if (v2 instanceof Weight) {
                  return Weight.create(v2.value0)((v / v1) * v2.value1);
              };
              if (v2 instanceof Volume) {
                  return Volume.create(v2.value0)((v / v1) * v2.value1);
              };
              if (v2 instanceof IncompatibleQuantity) {
                  return IncompatibleQuantity.value;
              };
              ...
              throw new Error("Failed pattern match at Calculator.Model line 488, column 1 - line 488, column 55: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var rainwaterCollectingParam = {
      title: "Water collectin", 
      surfaceArea: new SurfaceArea(0.0), 
      collectingCapacity: 0.6
  };
  var quantityEq = new Data_Eq.Eq(function (v) {
      return function (v1) {
          ...
          if (v instanceof ZeroQuantity && v1 instanceof ZeroQuantity) {
              return true;
          };
          if (v instanceof ZeroQuantity && v1 instanceof Weight) {
              return $$Math.abs(v1.value1 - 0.0) < 1.0e-4;
          };
          if (v instanceof Weight && v1 instanceof ZeroQuantity) {
              return $$Math.abs(v.value1 - 0.0) < 1.0e-4;
          };
          return false;
      };
  });
  var quantityOrd = new Data_Ord.Ord(function () {
      return quantityEq;
  }, function (v) {
      return function (v1) {
          if (v instanceof Weight && v1 instanceof Weight) {
          ...
          if (v instanceof ZeroQuantity && v1 instanceof Weight) {
              return Data_Ord.compare(Data_Ord.ordNumber)(0.0)(v1.value1);
          };
          if (v instanceof Weight && v1 instanceof ZeroQuantity) {
              return Data_Ord.compare(Data_Ord.ordNumber)(v.value1)(0.0);
          };
          if (v instanceof Volume && v1 instanceof ZeroQuantity) {
              return Data_Ord.compare(Data_Ord.ordNumber)(v.value1)(0.0);
          };
          if (v instanceof ZeroQuantity && v1 instanceof Volume) {
              return Data_Ord.compare(Data_Ord.ordNumber)(0.0)(v1.value1);
          };
          if (v instanceof ZeroQuantity && v1 instanceof ZeroQuantity) {
              return Data_Ordering.EQ.value;
          };
          if (v instanceof Weight && v1 instanceof Volume) {
              return Data_Ordering.GT.value;
          };
          if (v instanceof Volume && v1 instanceof Weight) {
          ...
          throw new Error("Failed pattern match at Calculator.Model line 98, column 3 - line 98, column 54: " + [ v.constructor.name, v1.constructor.name ]);
      };
  });
  var negQty = function (v) {
      ...
      throw new Error("Failed pattern match at Calculator.Model line 112, column 1 - line 112, column 41: " + [ v.constructor.name ]);
  };
  ...
  var mulQty = function (v) {
      return function (v1) {
          if (v1 instanceof Weight) {
              return new Weight(v1.value0, v * v1.value1);
          };
          if (v1 instanceof Volume) {
              return new Volume(v1.value0, v * v1.value1);
          };
          if (v1 instanceof ZeroQuantity) {
              return ZeroQuantity.value;
          };
          ...
          throw new Error("Failed pattern match at Calculator.Model line 132, column 1 - line 132, column 45: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
 ...
 */  
  ...
  var genericProcess = new Data_Generic.Generic(function (v) {
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.AllProcess" && v.value1.length === 0)) {
          return new Data_Maybe.Just(AllProcess.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Shopping" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Shopping.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Eating" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Eating.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Binning" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Binning.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.WormComposting" && v.value1.length === 0)) {
          return new Data_Maybe.Just(WormComposting.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.ManagingWaste" && v.value1.length === 0)) {
          return new Data_Maybe.Just(ManagingWaste.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.FoodSharing" && v.value1.length === 0)) {
          return new Data_Maybe.Just(FoodSharing.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.FoodGardening" && v.value1.length === 0)) {
          return new Data_Maybe.Just(FoodGardening.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.RainwaterCollecting" && v.value1.length === 0)) {
          return new Data_Maybe.Just(RainwaterCollecting.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Living" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Living.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Raining" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Raining.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.TapWaterSupplying" && v.value1.length === 0)) {
          return new Data_Maybe.Just(TapWaterSupplying.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Debug" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Debug.value);
      };
      return Data_Maybe.Nothing.value;
  }, function ($dollarq) {
      return new Data_Generic.SigProd("Calculator.Model.Process", [ {
          sigConstructor: "Calculator.Model.AllProcess", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Shopping", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Eating", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Binning", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.WormComposting", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.ManagingWaste", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.FoodSharing", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.FoodGardening", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.RainwaterCollecting", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Living", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Raining", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.TapWaterSupplying", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Debug", 
          sigValues: [  ]
      } ]);
  }, function (v) {
      if (v instanceof AllProcess) {
          return new Data_Generic.SProd("Calculator.Model.AllProcess", [  ]);
      };
      if (v instanceof Shopping) {
          return new Data_Generic.SProd("Calculator.Model.Shopping", [  ]);
      };
      if (v instanceof Eating) {
          return new Data_Generic.SProd("Calculator.Model.Eating", [  ]);
      };
      if (v instanceof Binning) {
          return new Data_Generic.SProd("Calculator.Model.Binning", [  ]);
      };
      if (v instanceof WormComposting) {
          return new Data_Generic.SProd("Calculator.Model.WormComposting", [  ]);
      };
      if (v instanceof ManagingWaste) {
          return new Data_Generic.SProd("Calculator.Model.ManagingWaste", [  ]);
      };
      if (v instanceof FoodSharing) {
          return new Data_Generic.SProd("Calculator.Model.FoodSharing", [  ]);
      };
      if (v instanceof FoodGardening) {
          return new Data_Generic.SProd("Calculator.Model.FoodGardening", [  ]);
      };
      if (v instanceof RainwaterCollecting) {
          return new Data_Generic.SProd("Calculator.Model.RainwaterCollecting", [  ]);
      };
      if (v instanceof Living) {
          return new Data_Generic.SProd("Calculator.Model.Living", [  ]);
      };
      if (v instanceof Raining) {
          return new Data_Generic.SProd("Calculator.Model.Raining", [  ]);
      };
      if (v instanceof TapWaterSupplying) {
          return new Data_Generic.SProd("Calculator.Model.TapWaterSupplying", [  ]);
      };
      if (v instanceof Debug) {
          return new Data_Generic.SProd("Calculator.Model.Debug", [  ]);
      };
      throw new Error("Failed pattern match at Calculator.Model line 197, column 1 - line 197, column 50: " + [ v.constructor.name ]);
  });
  var processEq = new Data_Eq.Eq(function (v) {
      return function (v1) {
          if (v instanceof AllProcess) {
              return true;
          };
          if (v1 instanceof AllProcess) {
              return true;
          };
          return Data_Generic.gEq(genericProcess)(v)(v1);
      };
  });
 ...
 */  
  ...
  var genericOptions = new Data_Generic.Generic(function (v) {
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.EatingOnly" && v.value1.length === 0)) {
          return new Data_Maybe.Just(EatingOnly.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.EatingBinning" && v.value1.length === 0)) {
          return new Data_Maybe.Just(EatingBinning.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.EatingBinningWormComposting" && v.value1.length === 0)) {
          return new Data_Maybe.Just(EatingBinningWormComposting.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.EatingBinningWormCompostingFoodGardening" && v.value1.length === 0)) {
          return new Data_Maybe.Just(EatingBinningWormCompostingFoodGardening.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.EatingBinningWormCompostingFoodGardenWatering" && v.value1.length === 0)) {
          return new Data_Maybe.Just(EatingBinningWormCompostingFoodGardenWatering.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.EatingBinningWormCompostingFoodGardenRainwater" && v.value1.length === 0)) {
          return new Data_Maybe.Just(EatingBinningWormCompostingFoodGardenRainwater.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.EatingBinningFoodSharing" && v.value1.length === 0)) {
          return new Data_Maybe.Just(EatingBinningFoodSharing.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.EatingBinningWormCompostingFoodSharing" && v.value1.length === 0)) {
          return new Data_Maybe.Just(EatingBinningWormCompostingFoodSharing.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Tank" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Tank.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.NotImplemented" && v.value1.length === 0)) {
          return new Data_Maybe.Just(NotImplemented.value);
      };
      return Data_Maybe.Nothing.value;
  }, function ($dollarq) {
      return new Data_Generic.SigProd("Calculator.Model.Options", [ {
          sigConstructor: "Calculator.Model.EatingOnly", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.EatingBinning", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.EatingBinningWormComposting", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.EatingBinningWormCompostingFoodGardening", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.EatingBinningWormCompostingFoodGardenWatering", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.EatingBinningWormCompostingFoodGardenRainwater", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.EatingBinningFoodSharing", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.EatingBinningWormCompostingFoodSharing", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Tank", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.NotImplemented", 
          sigValues: [  ]
      } ]);
  }, function (v) {
      if (v instanceof EatingOnly) {
          return new Data_Generic.SProd("Calculator.Model.EatingOnly", [  ]);
      };
      if (v instanceof EatingBinning) {
          return new Data_Generic.SProd("Calculator.Model.EatingBinning", [  ]);
      };
      if (v instanceof EatingBinningWormComposting) {
          return new Data_Generic.SProd("Calculator.Model.EatingBinningWormComposting", [  ]);
      };
      if (v instanceof EatingBinningWormCompostingFoodGardening) {
          return new Data_Generic.SProd("Calculator.Model.EatingBinningWormCompostingFoodGardening", [  ]);
      };
      if (v instanceof EatingBinningWormCompostingFoodGardenWatering) {
          return new Data_Generic.SProd("Calculator.Model.EatingBinningWormCompostingFoodGardenWatering", [  ]);
      };
      if (v instanceof EatingBinningWormCompostingFoodGardenRainwater) {
          return new Data_Generic.SProd("Calculator.Model.EatingBinningWormCompostingFoodGardenRainwater", [  ]);
      };
      if (v instanceof EatingBinningFoodSharing) {
          return new Data_Generic.SProd("Calculator.Model.EatingBinningFoodSharing", [  ]);
      };
      if (v instanceof EatingBinningWormCompostingFoodSharing) {
          return new Data_Generic.SProd("Calculator.Model.EatingBinningWormCompostingFoodSharing", [  ]);
      };
      if (v instanceof Tank) {
          return new Data_Generic.SProd("Calculator.Model.Tank", [  ]);
      };
      if (v instanceof NotImplemented) {
          return new Data_Generic.SProd("Calculator.Model.NotImplemented", [  ]);
      };
      throw new Error("Failed pattern match at Calculator.Model line 295, column 1 - line 295, column 50: " + [ v.constructor.name ]);
  });
  var showOptions = new Data_Show.Show(Data_Generic.gShow(genericOptions));
  var genericMatterProperty = new Data_Generic.Generic(function (v) {
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Edible" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Edible.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.NonEdible" && v.value1.length === 0)) {
          return new Data_Maybe.Just(NonEdible.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Shopped" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Shopped.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Cooked" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Cooked.value);
      };
      ...
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.TapWater" && v.value1.length === 0)) {
          return new Data_Maybe.Just(TapWater.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.AllMatterProperty" && v.value1.length === 0)) {
          return new Data_Maybe.Just(AllMatterProperty.value);
      };
      return Data_Maybe.Nothing.value;
  }, function ($dollarq) {
      return new Data_Generic.SigProd("Calculator.Model.MatterProperty", [ {
          sigConstructor: "Calculator.Model.Edible", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.NonEdible", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Shopped", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Cooked", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.GreyWater", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.TapWater", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.AllMatterProperty", 
          sigValues: [  ]
      } ]);
  }, function (v) {
      if (v instanceof Edible) {
          return new Data_Generic.SProd("Calculator.Model.Edible", [  ]);
      };
      if (v instanceof NonEdible) {
          return new Data_Generic.SProd("Calculator.Model.NonEdible", [  ]);
      };
      if (v instanceof Shopped) {
          return new Data_Generic.SProd("Calculator.Model.Shopped", [  ]);
      };
      if (v instanceof Cooked) {
          return new Data_Generic.SProd("Calculator.Model.Cooked", [  ]);
      };
      if (v instanceof GreyWater) {
          return new Data_Generic.SProd("Calculator.Model.GreyWater", [  ]);
      };
      if (v instanceof TapWater) {
          return new Data_Generic.SProd("Calculator.Model.TapWater", [  ]);
      };
      if (v instanceof AllMatterProperty) {
          return new Data_Generic.SProd("Calculator.Model.AllMatterProperty", [  ]);
      };
      throw new Error("Failed pattern match at Calculator.Model line 221, column 1 - line 221, column 64: " + [ v.constructor.name ]);
  });
  var matterProperty = new Data_Eq.Eq(function (v) {
      return function (v1) {
          if (v instanceof AllMatterProperty) {
              return true;
          };
          if (v1 instanceof AllMatterProperty) {
              return true;
          };
          return Data_Generic.gEq(genericMatterProperty)(v)(v1);
      };
  });
  var genericMatter = new Data_Generic.Generic(function (v) {
      ...
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Water" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Water.value);
      };
      ...
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.Fertilizer" && v.value1.length === 0)) {
          return new Data_Maybe.Just(Fertilizer.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.GreenhouseGas" && v.value1.length === 0)) {
          return new Data_Maybe.Just(GreenhouseGas.value);
      };
      return Data_Maybe.Nothing.value;
  }, function ($dollarq) {
      return new Data_Generic.SigProd("Calculator.Model.Matter", [ {
          ...
          sigConstructor: "Calculator.Model.Water", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Compost", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.Fertilizer", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.GreenhouseGas", 
          sigValues: [  ]
      } ]);
  }, function (v) {
      ...
      if (v instanceof Water) {
          return new Data_Generic.SProd("Calculator.Model.Water", [  ]);
      };
      if (v instanceof Compost) {
          return new Data_Generic.SProd("Calculator.Model.Compost", [  ]);
      };
      if (v instanceof Fertilizer) {
          return new Data_Generic.SProd("Calculator.Model.Fertilizer", [  ]);
      };
      if (v instanceof GreenhouseGas) {
          return new Data_Generic.SProd("Calculator.Model.GreenhouseGas", [  ]);
      };
      throw new Error("Failed pattern match at Calculator.Model line 209, column 1 - line 209, column 48: " + [ v.constructor.name ]);
  });
  var matterEq = new Data_Eq.Eq(function (v) {
      return function (v1) {
          if (v instanceof AllMatter) {
              return true;
          };
          if (v1 instanceof AllMatter) {
              return true;
          };
          return Data_Generic.gEq(genericMatter)(v)(v1);
      };
  });
  ...
  var foodGardeningParam = {
      title: "Food Garden", 
      surfaceArea: new SurfaceArea(50.0), 
      fertilizerNeed: {
          tomato: new Weight(Fertilizer.value, 2.17)
      }, 
      greyWaterNeed: {
          tomato: new Volume(Water.value, 60.0)
      }, 
      plant: Tomato.value, 
      productionCapacity: {
          tomato: new Weight(Food.value, 2.44)
      }, 
      irrigationEfficiency: new Ratio(Water.value, {
          ratio: 0.45
      })
  };
  ...
  var divByRatio = function (qty) {
      return function (v) {
          var divRatio = function (v1) {
              return function (r) {
                  if (v1 instanceof Weight) {
                      return Weight.create(v1.value0)(v1.value1 / r);
                  };
                  if (v1 instanceof Volume) {
                      return Volume.create(v1.value0)(v1.value1 / r);
                  };
                  if (v1 instanceof ZeroQuantity) {
                      return ZeroQuantity.value;
                  };
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 449, column 5 - line 449, column 47: " + [ v1.constructor.name, r.constructor.name ]);
              };
          };
          return divRatio(qty)(v.value1.ratio);
      };
  };
 ...
 */  
  var foodGardening_EatingBinningWormCompostingFoodGardening = function (v) {
      return function (v1) {
          return function (v2) {
             ...
             */  
              var surfaceArea$prime = v.surfaceArea.value0;
              var tapWaterUsedByPlants = scaleQtyOnTime(v1)(mulQty(surfaceArea$prime)(v.greyWaterNeed.tomato));
              var tapWaterNeeded = divByRatio(tapWaterUsedByPlants)(v.irrigationEfficiency);
              var producedFood = mulQty(surfaceArea$prime)(v.productionCapacity.tomato);
              var fertilizerNeeded = scaleQtyOnTime(v1)(mulQty(surfaceArea$prime)(v.fertilizerNeed.tomato));
              var availableTapWater = foldState(TapWaterSupplying.value)(Water.value)(TapWater.value)(v2);
              var availableCompost = foldState(WormComposting.value)(Compost.value)(AllMatterProperty.value)(v2);
              var usedCompost = (function () {
                  var $447 = Data_Ord.greaterThan(quantityOrd)(fertilizerNeeded)(availableCompost);
                  if ($447) {
                      return availableCompost;
                  };
                  if (!$447) {
                      return subQty(availableCompost)(fertilizerNeeded);
                  };
                  throw new Error("Failed pattern match at Calculator.Model line 543, column 19 - line 544, column 83: " + [ $447.constructor.name ]);
              })();
              return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v2.value0)([ new Entry({
                  process: WormComposting.value, 
                  matter: Compost.value, 
                  matterProperty: AllMatterProperty.value, 
                  quantity: negQty(usedCompost)
              }), new Entry({
                  process: FoodGardening.value, 
                  matter: Fertilizer.value, 
                  matterProperty: AllMatterProperty.value, 
                  quantity: subQty(fertilizerNeeded)(usedCompost)
              }), new Entry({
                  process: TapWaterSupplying.value, 
                  matter: Water.value, 
                  matterProperty: TapWater.value, 
                  quantity: negQty(tapWaterNeeded)
              }), new Entry({
                  process: FoodGardening.value, 
                  matter: Water.value, 
                  matterProperty: TapWater.value, 
                  quantity: tapWaterNeeded
              }), new Entry({
                  process: FoodGardening.value, 
                  matter: Food.value, 
                  matterProperty: Edible.value, 
                  quantity: producedFood
              }) ]));
          };
      };
  };
  var foodGardening_EatingBinningWormCompostingFoodGardeningRainwater = function (v) {
      return function (systemScale) {
          return function (v1) {
             ...
             */  
              var surfaceArea$prime = v.surfaceArea.value0;
              var producedFood = mulQty(surfaceArea$prime)(v.productionCapacity.tomato);
              var greyWaterUsedByPlants = scaleQtyOnTime(systemScale)(mulQty(surfaceArea$prime)(v.greyWaterNeed.tomato));
              var greyWaterNeeded = divByRatio(greyWaterUsedByPlants)(v.irrigationEfficiency);
              var fertilizerNeeded = mulQty(v.surfaceArea.value0)(v.fertilizerNeed.tomato);
              var availableGreyWater = foldState(RainwaterCollecting.value)(Water.value)(GreyWater.value)(v1);
              var usedGreyWater = (function () {
                  var $467 = Data_Ord.greaterThan(quantityOrd)(greyWaterNeeded)(availableGreyWater);
                  if ($467) {
                      return availableGreyWater;
                  };
                  if (!$467) {
                      return subQty(availableGreyWater)(greyWaterNeeded);
                  };
                  throw new Error("Failed pattern match at Calculator.Model line 581, column 21 - line 582, column 88: " + [ $467.constructor.name ]);
              })();
              var availableCompost = foldState(WormComposting.value)(Compost.value)(AllMatterProperty.value)(v1);
              var usedCompost = (function () {
                  var $468 = Data_Ord.greaterThan(quantityOrd)(fertilizerNeeded)(availableCompost);
                  if ($468) {
                      return availableCompost;
                  };
                  if (!$468) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 574, column 19 - line 575, column 83: " + [ $468.constructor.name ]);
              })();
              return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
                  ...
                  process: RainwaterCollecting.value, 
                  matter: Water.value, 
                  matterProperty: GreyWater.value, 
                  quantity: negQty(usedGreyWater)
              }), new Entry({
                  process: FoodGardening.value, 
                  matter: Water.value, 
                  matterProperty: GreyWater.value, 
                  quantity: usedGreyWater
              }), new Entry({
                  process: FoodGardening.value, 
                  matter: Food.value, 
                  matterProperty: Edible.value, 
  ...
  var complementOneTransform = function (v) {
      return new Transform(v.value0, v.value1, {
          ratio: 1.0 - v.value2.ratio
      });
  };
  ...
  var cappedQty = function (v) {
      return function (v1) {
          if (v instanceof Weight && (v1 instanceof Weight && v.value1 < v1.value1)) {
              return new Weight(v.value0, v.value1);
          };
          if (v instanceof Weight && v1 instanceof Weight) {
              return new Weight(v.value0, v1.value1);
          };
          if (v instanceof Volume && (v1 instanceof Volume && v.value1 < v1.value1)) {
              return new Volume(v.value0, v.value1);
          };
          if (v instanceof Volume && v1 instanceof Volume) {
              return new Volume(v.value0, v1.value1);
          };
          if (v1 instanceof ZeroQuantity) {
              return v;
          };
  ...
  var blockToRoofSurface = function (v) {
      return v.value0 * 342.25;
  };
  var rainwaterCollecting_EatingBinningWormCompostingFoodGardenRainwater = function (v) {
      return function (systemScale) {
          return function (v1) {
              var surfaceArea$prime = blockToRoofSurface(v.surfaceArea);
              var rainingWater = foldState(Raining.value)(Water.value)(AllMatterProperty.value)(v1);
              var collectedWater = Volume.create(Water.value)(surfaceArea$prime * scaleNumberOnTime(systemScale)(v.collectingCapacity));
              return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
                  process: Raining.value, 
                  matter: Water.value, 
                  matterProperty: GreyWater.value, 
  ...
  var initProcessParams = {
      ...
      foodGardeningParam: foodGardeningParam, 
      rainwaterCollectingParam: rainwaterCollectingParam
  };
  var applyTransform = function (v) {
      var createQuantity = function (v1) {
          ...
          throw new Error("Failed pattern match at Calculator.Model line 428, column 5 - line 428, column 51: " + [ v1.constructor.name ]);
      };
      ...
      return function (qty) {
          var appRatio = function (r) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 438, column 5 - line 438, column 47: " + [ r.constructor.name, v1.constructor.name ]);
              };
          };
  ...
  var composting_EatingBinningWormComposting = function (v) {
      return function (systemScale) {
          return function (v1) {
             ...
             */  
              var wormeryCapacity = applyRatio(new Ratio(Compost.value, {
                  ratio: Data_Int.toNumber(v.numberWormeries)
              }))(new Weight(Compost.value, 80.0));
              ...
              var compostProduct = applyTransform(v.compostingYield)(scaleQtyOnTime(systemScale)(cappedQty(wormeryCapacity)(compostableWaste)));
              return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
  ...
  var eating = function (v) {
      return function (v1) {
          ...
          var wasted = rangeScale(Data_Int.toNumber(v.numberHouseholdEating))(121.0)(applyTransform(complementOneRatioTransform(v.eatedFoodRatio))(shoppedFood));
          var eatedFood = rangeScale(Data_Int.toNumber(v.numberHouseholdEating))(121.0)(applyRatio(v.eatedFoodRatio)(shoppedFood));
          return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
  ...
  var eating_EatingBinningWormCompostingFoodSharing = function (v) {
      return function (v1) {
          var shoppedFood = foldState(Shopping.value)(Food.value)(AllMatterProperty.value)(v1);
          var wasted = applyTransform(complementOneRatioTransform(v.eatedFoodRatio))(shoppedFood);
          var nonedibleWasted = applyTransform(complementOneTransform(v.edibleWasteProcess))(wasted);
          var edibleWasted = applyTransform(v.edibleWasteProcess)(wasted);
          var eatedFood = applyRatio(v.eatedFoodRatio)(shoppedFood);
          return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
              process: Shopping.value, 
              matter: Food.value, 
              matterProperty: AllMatterProperty.value, 
              quantity: negQty(eatedFood)
          }), new Entry({
              process: Living.value, 
              matter: Food.value, 
              matterProperty: AllMatterProperty.value, 
              ...
              matter: Food.value, 
              matterProperty: Edible.value, 
              quantity: edibleWasted
          }), new Entry({
              process: Eating.value, 
              matter: Waste.value, 
              matterProperty: NonEdible.value, 
              quantity: nonedibleWasted
          }) ]));
      };
  };
  var foodSharing = function (v) {
      return function (v1) {
          var edibleWasted = foldState(Eating.value)(Food.value)(Edible.value)(v1);
          var edibleShared = rangeScale(Data_Int.toNumber(v.numberSharingHouseholds))(121.0)(applyRatio(v.sharedFoodRatio)(edibleWasted));
          return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
              process: Eating.value, 
              matter: Waste.value, 
              matterProperty: AllMatterProperty.value, 
              quantity: negQty(edibleShared)
          }), new Entry({
              process: FoodSharing.value, 
              matter: Food.value, 
              matterProperty: Edible.value, 
              quantity: edibleShared
          }) ]));
      };
  };
  ...
  var binning = function (v) {
      return function (v1) {
          ...
          var allWaste = addQty(foodWormComposting)(foodWaste);
          var compactedWasteVolume = rangeScale(Data_Int.toNumber(v.numberCompactors))(121.0)(applyRatio(v.compactingRatio)(toVolume(v.bulkDensity)(allWaste)));
          var allWasteVolume = subQty(toVolume(v.bulkDensity)(allWaste))(compactedWasteVolume);
          return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
              process: Eating.value, 
              matter: Waste.value, 
              matterProperty: AllMatterProperty.value, 
 ...
 */  
  var managingWaste = function (v) {
      return function (v1) {
          ...
          var allWasteVolume = addQty(toVolume(v.bulkDensity)(foodWaste))(toVolume(v.bulkDensity)(binnedWaste));
          var ghgEmitted = mulQty(v.ghgProduction)(allWasteVolume);
          return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
              process: Eating.value, 
              matter: Waste.value, 
              matterProperty: AllMatterProperty.value, 
  ...
  var nexusSystem = function (v) {
      var state$prime = scaleFirstEntry(v.value0.scale)(v.value0.systemParams)(v.value0.state);
      var endState = (function () {
          ...
          if (v.value0.current instanceof EatingBinningWormComposting) {
              return managingWaste(v.value0.processParams.managedWasteParam)(binning(v.value0.processParams.binningParam)(composting_EatingBinningWormComposting(v.value0.processParams.wormCompostingParam)(v.value0.scale)(eating(v.value0.processParams.eatingParam)(state$prime))));
          };
          if (v.value0.current instanceof EatingBinningWormCompostingFoodGardening) {
              return managingWaste(v.value0.processParams.managedWasteParam)(binning(v.value0.processParams.binningParam)(foodGardening_EatingBinningWormCompostingFoodGardening(v.value0.processParams.foodGardeningParam)(v.value0.scale)(composting_EatingBinningWormComposting(v.value0.processParams.wormCompostingParam)(v.value0.scale)(eating(v.value0.processParams.eatingParam)(state$prime)))));
          };
          if (v.value0.current instanceof EatingBinningWormCompostingFoodGardenWatering) {
              return managingWaste(v.value0.processParams.managedWasteParam)(binning(v.value0.processParams.binningParam)(foodGardening_EatingBinningWormCompostingFoodGardening(v.value0.processParams.foodGardeningParam)(v.value0.scale)(composting_EatingBinningWormComposting(v.value0.processParams.wormCompostingParam)(v.value0.scale)(eating(v.value0.processParams.eatingParam)(state$prime)))));
          };
          if (v.value0.current instanceof EatingBinningWormCompostingFoodGardenRainwater) {
              return managingWaste(v.value0.processParams.managedWasteParam)(binning(v.value0.processParams.binningParam)(foodGardening_EatingBinningWormCompostingFoodGardeningRainwater(v.value0.processParams.foodGardeningParam)(v.value0.scale)(rainwaterCollecting_EatingBinningWormCompostingFoodGardenRainwater(v.value0.processParams.rainwaterCollectingParam)(v.value0.scale)(composting_EatingBinningWormComposting(v.value0.processParams.wormCompostingParam)(v.value0.scale)(eating(v.value0.processParams.eatingParam)(state$prime))))));
          };
          if (v.value0.current instanceof EatingBinningFoodSharing) {
              return managingWaste(v.value0.processParams.managedWasteParam)(binning(v.value0.processParams.binningParam)(foodSharing(v.value0.processParams.foodSharingParam)(eating_EatingBinningWormCompostingFoodSharing(v.value0.processParams.eatingParam)(state$prime))));
          };
          if (v.value0.current instanceof EatingBinningWormCompostingFoodSharing) {
              return managingWaste(v.value0.processParams.managedWasteParam)(binning(v.value0.processParams.binningParam)(composting_EatingBinningWormComposting(v.value0.processParams.wormCompostingParam)(v.value0.scale)(foodSharing(v.value0.processParams.foodSharingParam)(eating_EatingBinningWormCompostingFoodSharing(v.value0.processParams.eatingParam)(state$prime)))));
          };
          if (v.value0.current instanceof Tank) {
              return new State([  ]);
          };
          return new State([  ]);
      })();
      return SystemState.create((function () {
          var $582 = {};
          for (var $583 in v.value0) {
              if (v.value0.hasOwnProperty($583)) {
                  $582[$583] = v.value0[$583];
              };
          };
          $582.state = endState;
          return $582;
  ...
  exports["EatingBinningWormCompostingFoodGardening"] = EatingBinningWormCompostingFoodGardening;
  ...
  exports["EatingBinningFoodSharing"] = EatingBinningFoodSharing;
  ...
  exports["FoodSharing"] = FoodSharing;
  exports["FoodGardening"] = FoodGardening;
  exports["RainwaterCollecting"] = RainwaterCollecting;
  exports["Living"] = Living;
  exports["Raining"] = Raining;
  exports["TapWaterSupplying"] = TapWaterSupplying;
  exports["Debug"] = Debug;
  ...
  exports["quantityEq"] = quantityEq;
  exports["quantityOrd"] = quantityOrd;
  ...
  exports["genericMatterProperty"] = genericMatterProperty;
...
(function(exports) {
  ...
  var Data_Semigroup = PS["Data.Semigroup"];
  var Data_Show = PS["Data.Show"];
  var managedWaste = Calculator_Model.initialState(Calculator_Model.ManagingWaste.value)(Calculator_Model.Waste.value)(Calculator_Model.AllMatterProperty.value);
  ...
  var initialFoodShared = Calculator_Model.initialState(Calculator_Model.FoodSharing.value)(Calculator_Model.Food.value)(Calculator_Model.AllMatterProperty.value);
  var initialFoodGardeningTapWater = Calculator_Model.initialState(Calculator_Model.FoodGardening.value)(Calculator_Model.Water.value)(Calculator_Model.AllMatterProperty.value);
  var initialFoodGardeningRainwater = Calculator_Model.initialState(Calculator_Model.FoodGardening.value)(Calculator_Model.Water.value)(Calculator_Model.GreyWater.value);
  ...
  var initialCompost = Calculator_Model.initialState(Calculator_Model.WormComposting.value)(Calculator_Model.Compost.value)(Calculator_Model.AllMatterProperty.value);
 ...
 */  
          ...
          return function (item) {
             ...
             */  
              var image = function (v) {
                  ...
                  if (v === "Food Garden") {
                      return "/images/food_garden.svg";
                  };
                  if (v === "Food Sharing") {
                      return "/images/food_sharing.svg";
                  };
                  if (v === "Shopped Food") {
                  ...
                  if (v === "Rainwater") {
                      return "/images/rainwater.svg";
                  };
                  if (v === "Rainfall") {
                      return "/images/rainwater.svg";
                  };
                  if (v === "Tap Water") {
                      return "/images/tapwater.svg";
                  };
                  if (v === "Rainwater Collection") {
                      return "/images/rainwater_collection.svg";
                  };
                  if (v === "Tank") {
                      return "/images/rainwater_harvesting.svg";
                  };
                  if (v === "Wastewater") {
                      return "/images/wastewater.svg";
                  };
                  if (v === "_") {
              ...
              var hoverClass = function (v) {
                  return function (v1) {
                      ...
                      throw new Error("Failed pattern match at Calculator.Layout line 47, column 1 - line 77, column 1: " + [ v.constructor.name, v1.constructor.name ]);
                  };
              };
  ...
  var ghgEmitted = Calculator_Model.initialState(Calculator_Model.ManagingWaste.value)(Calculator_Model.GreenhouseGas.value)(Calculator_Model.AllMatterProperty.value);
  var gardenWaterNeed = Calculator_Model.initialState(Calculator_Model.RainwaterCollecting.value)(Calculator_Model.Water.value)(Calculator_Model.GreyWater.value);
  var gardenFood = Calculator_Model.foldState(Calculator_Model.FoodGardening.value)(Calculator_Model.Food.value)(Calculator_Model.AllMatterProperty.value);
  var flow = function (item) {
      var tokenToHex = function (v) {
          ...
          if (v.title === "\\") {
              return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.li)(Text_Smolder_HTML_Attributes.className("hex rotate-2"))(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.a)(Text_Smolder_HTML_Attributes.className("hexIn hover"))(Control_Bind.bind(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_HTML.h2(Text_Smolder_Markup.text(v.quantity)))(function () {
                  return Control_Bind.bind(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_HTML.p(Text_Smolder_Markup.text(v.details)))(function () {
                      return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("arrow-css right"))(Data_Monoid.mempty(Text_Smolder_Markup.monoidMarkup));
                  });
              })));
  ...
  var eatedFood = Calculator_Model.foldState(Calculator_Model.Living.value)(Calculator_Model.Food.value)(Calculator_Model.AllMatterProperty.value);
  var arrayArrow = function (v) {
      if (v.value0.current instanceof Calculator_Model.EatingOnly) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(7)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(2)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
          ...
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyArrow))(Data_Array.replicate(7)(emptyArrow))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinning) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(7)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(1)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialShoppedFood(v.value0.state)), 
              details: "of Food"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
      ...
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormComposting) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(managedWaste(v.value0.state)), 
              details: "of Waste"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(2)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(2)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "/", 
              ...
              details: "of Food Waste"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(1)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialShoppedFood(v.value0.state)), 
              details: "of Food"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              ...
              details: "of Compostable Waste "
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyArrow))(Data_Array.replicate(7)(emptyArrow))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormCompostingFoodGardening) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(managedWaste(v.value0.state)), 
              details: "of Waste"
              ...
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialCompost(v.value0.state)), 
              details: "of Fertiliser"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(1)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(5)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "/", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialFoodGardeningTapWater(v.value0.state)), 
              details: "of Irrigation Water"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyArrow))(Data_Array.replicate(7)(emptyArrow)))))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormCompostingFoodGardenWatering) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(managedWaste(v.value0.state)), 
              details: "of Waste"
      ...
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormCompostingFoodGardenRainwater) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(managedWaste(v.value0.state)), 
              details: "of Waste"
              ...
              title: "/", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(gardenWaterNeed(v.value0.state)), 
              details: "of Irrigation Water"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(1)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialFoodGardeningRainwater(v.value0.state)), 
              details: "of Rainwater Collected"
          }))(Data_Array.replicate(7)(emptyArrow)))))))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinningFoodSharing) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(managedWaste(v.value0.state)), 
              details: "of Waste"
              ...
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialShoppedFood(v.value0.state)), 
              details: "of Food"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(2)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "\\", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialFoodShared(v.value0.state)), 
              details: "of Food Shared"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyArrow))(Data_Array.replicate(7)(emptyArrow))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormCompostingFoodSharing) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(managedWaste(v.value0.state)), 
              details: "of Waste"
              ...
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialCompost(v.value0.state)), 
              details: "of Fertiliser"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(1)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(2)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "\\", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialFoodShared(v.value0.state)), 
              details: "of Food Shared"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyArrow))(Data_Array.replicate(7)(emptyArrow)))))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.Tank) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(7)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(2)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialShoppedFood(v.value0.state)), 
              details: "of Rainfall"
  ...
  var additionalFertilizerNeeded = Calculator_Model.foldState(Calculator_Model.FoodGardening.value)(Calculator_Model.Fertilizer.value)(Calculator_Model.AllMatterProperty.value);
 ...
 */  
  var arrayHex = function (v) {
      if (v.value0.current instanceof Calculator_Model.EatingOnly) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(7)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(1)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Shopped Food", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialShoppedFood(v.value0.state)) + " for the whole Estate"
              ...
              title: "Eating", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(eatedFood(v.value0.state)) + " eaten"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Managed Waste", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(ghgEmitted(v.value0.state)) + " CO2 emitted"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Array.replicate(7)(emptyHex))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinning) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(7)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Shopped Food", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialShoppedFood(v.value0.state)) + " for the whole Estate"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Eating", 
              ...
              title: "Binning", 
              details: "Manual compactors shrink waste by 30%"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Managed Waste", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(ghgEmitted(v.value0.state)) + " CO2 emitted"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Array.replicate(7)(emptyHex)))))))))));
      ...
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormComposting) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Binning", 
              details: "Manual compactors shrink waste by 30%"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Managed Waste", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(ghgEmitted(v.value0.state)) + " CO2 emitted"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Shopped Food", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialShoppedFood(v.value0.state)) + " for the whole Estate"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Eating", 
              ...
              title: "Wormery", 
              details: "100L size wormery"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Array.replicate(7)(emptyHex))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormCompostingFoodGardening) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Binning", 
              ...
              title: "Managed Waste", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(ghgEmitted(v.value0.state)) + " of CO2 emitted"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(1)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Shopped Food", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialShoppedFood(v.value0.state)) + " for the whole Estate"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Eating", 
              ...
              title: "Food Garden", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(gardenFood(v.value0.state)) + ("(Tomato) " + (Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(additionalFertilizerNeeded(v.value0.state)) + "(Fertilizer)"))
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(5)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Tap Water", 
              details: ""
          }))(Data_Array.replicate(1)(emptyHex)))))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormCompostingFoodGardenWatering) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Binning", 
      ...
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormCompostingFoodGardenRainwater) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              ...
              title: "Food Garden", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(gardenFood(v.value0.state))
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Rainwater", 
              details: "Tank with 18 days of water"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Rainwater Collection", 
              details: ""
          }))(Data_Array.singleton(emptyHex)))))))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinningFoodSharing) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Binning", 
              ...
              title: "Eating", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(eatedFood(v.value0.state)) + " eaten"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Food Sharing", 
              details: ""
          }))(Data_Array.replicate(3)(emptyHex))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormCompostingFoodSharing) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Binning", 
              ...
              title: "Food Sharing", 
              details: "Assuming 55% of shareable food"
          }))(Data_Array.replicate(3)(emptyHex)))))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.Tank) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(7)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(1)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
      ...
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(7)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(7)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(7)(emptyHex))(Data_Array.replicate(6)(emptyHex))))));
  };
  var hexes = function (hover) {
      return function (grid) {
          return function (v) {
              return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.ul)(Text_Smolder_HTML_Attributes.className("hexGrid processes")))(Text_Smolder_HTML_Attributes.id(Data_Show.show(Calculator_Model.showOptions)(v.value0.current)))(Data_Foldable.foldMap(Data_Foldable.foldableArray)(Text_Smolder_Markup.monoidMarkup)(hex(hover)(grid))(arrayHex(new Calculator_Model.SystemState(v.value0))));
          };
      };
  };
...
(function(exports) {
  ...
  var timescaleToString = function (v) {
      ...
      throw new Error("Failed pattern match at Rainwater line 123, column 1 - line 124, column 1: " + [ v.constructor.name ]);
  };
  ...
  var scaleToString = function (v) {
      ...
      throw new Error("Failed pattern match at Rainwater line 119, column 1 - line 120, column 1: " + [ v.constructor.name ]);
  };
  var ratio = function (v) {
      return v.value1.ratio;
  };
  var optionsLabel = function (v) {
      if (v instanceof Calculator_Model.Tank) {
          return "Tank";
      };
      ...
      if (v instanceof Calculator_Model.EatingBinningWormCompostingFoodGardening) {
      ...
      if (v instanceof Calculator_Model.EatingBinningFoodSharing) {
          return "Food Sharing";
      };
  ...
  var nexusOptions = Flare.select(Data_Foldable.foldableArray)("Options")(new Data_NonEmpty.NonEmpty(Calculator_Model.Tank.value, [ Calculator_Model.EatingBinning.value, Calculator_Model.EatingBinningWormCompostingFoodGardening.value, Calculator_Model.EatingBinningWormCompostingFoodGardenRainwater.value, Calculator_Model.EatingBinningWormCompostingFoodSharing.value ]))(optionsLabel);
  ...
  var initState = new Calculator_Model.State([ new Calculator_Model.Entry({
      ...
      process: Calculator_Model.Raining.value, 
      matter: Calculator_Model.Water.value, 
      matterProperty: Calculator_Model.GreyWater.value, 
      quantity: Calculator_Model.Volume.create(Calculator_Model.Water.value)(12000.0 * 1000.0)
  }), new Calculator_Model.Entry({
      process: Calculator_Model.TapWaterSupplying.value, 
      matter: Calculator_Model.Water.value, 
      matterProperty: Calculator_Model.TapWater.value, 
      quantity: new Calculator_Model.Volume(Calculator_Model.Water.value, 1.0e35)
  }) ]);
  var controllableParam = function (numberHouseholdEating) {
      return function (numberCompactors) {
          return function (numberWormeries) {
              return function (gardenSurface) {
                  return function (roofSurface) {
                      return function (numberSharingHouseholds) {
                          var $31 = {};
                          for (var $32 in Calculator_Model.initProcessParams) {
                              if (Calculator_Model.initProcessParams.hasOwnProperty($32)) {
                                  $31[$32] = Calculator_Model.initProcessParams[$32];
                              };
                          };
                          $31.eatingParam = (function () {
                              var $13 = {};
                              for (var $14 in Calculator_Model.initProcessParams.eatingParam) {
                                  if (Calculator_Model.initProcessParams.eatingParam.hasOwnProperty($14)) {
                                      $13[$14] = Calculator_Model.initProcessParams.eatingParam[$14];
                                  };
                              };
                              $13.numberHouseholdEating = numberHouseholdEating;
                              return $13;
                          })();
                          $31.binningParam = (function () {
                              var $16 = {};
                              for (var $17 in Calculator_Model.initProcessParams.binningParam) {
                                  if (Calculator_Model.initProcessParams.binningParam.hasOwnProperty($17)) {
                                      $16[$17] = Calculator_Model.initProcessParams.binningParam[$17];
                                  };
                              };
                              $16.numberCompactors = numberCompactors;
                              return $16;
                          })();
                          $31.wormCompostingParam = (function () {
                              var $19 = {};
                              for (var $20 in Calculator_Model.initProcessParams.wormCompostingParam) {
                                  if (Calculator_Model.initProcessParams.wormCompostingParam.hasOwnProperty($20)) {
                                      $19[$20] = Calculator_Model.initProcessParams.wormCompostingParam[$20];
                                  };
                              };
                              $19.numberWormeries = numberWormeries;
                              return $19;
                          })();
                          $31.foodGardeningParam = (function () {
                              var $22 = {};
                              for (var $23 in Calculator_Model.initProcessParams.foodGardeningParam) {
                                  if (Calculator_Model.initProcessParams.foodGardeningParam.hasOwnProperty($23)) {
                                      $22[$23] = Calculator_Model.initProcessParams.foodGardeningParam[$23];
                                  };
                              };
                              $22.surfaceArea = gardenSurface;
                              return $22;
                          })();
                          $31.rainwaterCollectingParam = (function () {
                              var $25 = {};
                              for (var $26 in Calculator_Model.initProcessParams.rainwaterCollectingParam) {
                                  if (Calculator_Model.initProcessParams.rainwaterCollectingParam.hasOwnProperty($26)) {
                                      $25[$26] = Calculator_Model.initProcessParams.rainwaterCollectingParam[$26];
                                  };
                              };
                              $25.surfaceArea = roofSurface;
                              return $25;
                          })();
                          $31.foodSharingParam = (function () {
                              var $28 = {};
                              for (var $29 in Calculator_Model.initProcessParams.foodSharingParam) {
                                  if (Calculator_Model.initProcessParams.foodSharingParam.hasOwnProperty($29)) {
                                      $28[$29] = Calculator_Model.initProcessParams.foodSharingParam[$29];
                                  };
                              };
                              $28.numberSharingHouseholds = numberSharingHouseholds;
                              return $28;
                          })();
                          return $31;
                      };
  ...
  var areaToInt = function (v) {
      return v.value0;
  };
  var ui = Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(Calculator_Layout["interface"])(Flare["boolean"]("Info")(false)))(Flare["boolean"]("Grid")(false)))(Data_Functor.map(Flare.functorUI)(Data_Functor.map(Data_Functor.functorFn)(Debug_Trace.spy)(Calculator_Model.nexusSystem))(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(systemState)(nexusOptions))(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(mkScale)(Flare.select(Data_Foldable.foldableArray)("Scale")(new Data_NonEmpty.NonEmpty(Calculator_Model.EstateScale.value, [ Calculator_Model.HouseholdScale.value, Calculator_Model.PersonScale.value ]))(scaleToString)))(Flare.select(Data_Foldable.foldableArray)("Time")(new Data_NonEmpty.NonEmpty(Calculator_Model.Day.value, [ Calculator_Model.Month.value, Calculator_Model.Year.value ]))(timescaleToString))))(Control_Applicative.pure(Flare.applicativeUI)(systemParams)))(Flare.fieldset("Eating Parameters")(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(controllableParam)(Flare.intSlider("numberHouseholdEating")(0)(121)(Calculator_Model.initProcessParams.eatingParam.numberHouseholdEating)))(Flare.intSlider("numberCompactors")(0)(121)(Calculator_Model.initProcessParams.binningParam.numberCompactors)))(Flare.intSlider("numberWormeries")(0)(10)(Calculator_Model.initProcessParams.wormCompostingParam.numberWormeries)))(Data_Functor.map(Flare.functorUI)(Calculator_Model.SurfaceArea.create)(Flare.numberSlider("gardenSurface")(0.0)(100.0)(1.0)(areaToInt(Calculator_Model.initProcessParams.foodGardeningParam.surfaceArea)))))(Data_Functor.map(Flare.functorUI)(Calculator_Model.SurfaceArea.create)(Flare.numberSlider("roofSurface")(0.0)(100.0)(1.0)(areaToInt(Calculator_Model.initProcessParams.rainwaterCollectingParam.surfaceArea)))))(Flare.intSlider("numberSharingHouseholds")(0)(121)(Calculator_Model.initProcessParams.foodSharingParam.numberSharingHouseholds)))))(Control_Applicative.pure(Flare.applicativeUI)(initState))));
  var main = Flare_Smolder.runFlareHTML("flare-controls")("output")(ui);
  exports["areaToInt"] = areaToInt;
