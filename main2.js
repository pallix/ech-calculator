...
(function(exports) {
  ...
  var showQuantity = function (dictShow) {
      return new Data_Show.Show(function (v) {
          ...
          if (v instanceof Volume) {
              return Data_Show.show(Data_Show.showNumber)((v.value1 * 10.0) / 10.0) + "L";
          };
          ...
          throw new Error("Failed pattern match at Calculator.Model line 242, column 5 - line 243, column 5: " + [ v.constructor.name ]);
      });
  };
      ...
      return function (v1) {
          return function (q) {
              var timeFactor = (function () {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 563, column 22 - line 567, column 9: " + [ v.time.constructor.name ]);
              })();
              var scaleFactor = (function () {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 559, column 23 - line 562, column 51: " + [ v.scale.constructor.name ]);
              })();
              ...
              var scaleQ = function (v2) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 557, column 1 - line 571, column 59: " + [ v2.constructor.name ]);
              };
              return scaleQ(q);
          };
      };
          ...
          return function (v) {
              var convertEntries = function (v1) {
                  return Entry.create((function () {
                      var $112 = {};
                      for (var $113 in v1.value0) {
                          if (v1.value0.hasOwnProperty($113)) {
                              $112[$113] = v1.value0[$113];
                          };
                      };
                      $112.quantity = scaleQty(systemScale)(systemParams)(v1.value0.quantity);
                      return $112;
                  })());
              };
  ...
  var rainwaterCollectingParam = {
      ...
      surfaceArea: new SurfaceArea(100.0), 
  ...
  var quantityOrd = new Data_Ord.Ord(function () {
      ...
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Calculator.Model line 97, column 3 - line 97, column 54: " + [ v.constructor.name, v1.constructor.name ]);
      };
  });
  var negQty = function (v) {
      ...
      throw new Error("Failed pattern match at Calculator.Model line 111, column 1 - line 111, column 41: " + [ v.constructor.name ]);
  };
  ...
  var mulQty = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Calculator.Model line 138, column 1 - line 138, column 45: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var genericProcess = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Calculator.Model line 161, column 1 - line 161, column 50: " + [ v.constructor.name ]);
  });
  ...
  var genericOptions = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Calculator.Model line 255, column 1 - line 255, column 50: " + [ v.constructor.name ]);
  });
  ...
  var genericMatterProperty = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Calculator.Model line 182, column 1 - line 182, column 64: " + [ v.constructor.name ]);
  });
  ...
  var genericMatter = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Calculator.Model line 170, column 1 - line 170, column 48: " + [ v.constructor.name ]);
  });
  ...
  var foodGardening_EatingBinningWormCompostingFoodGardening = function (v) {
      return function (v1) {
          var producedFood = mulQty(v.surfaceArea.value0)(v.productionCapacity.tomato);
          ...
          var usedCompost = (function () {
              var $339 = Data_Ord.greaterThan(quantityOrd)(fertilizerNeeded)(availableCompost);
              if ($339) {
              ...
              throw new Error("Failed pattern match at Calculator.Model line 462, column 19 - line 463, column 83: " + [ $339.constructor.name ]);
          })();
  ...
  var rainwaterCollecting_EatingBinningWormCompostingFoodGardenRainwater = function (v) {
      return function (v1) {
          ...
          var collectedWater = Volume.create(Water.value)(v.surfaceArea.value0 * v.collectingCapacity);
          return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
  ...
  var applyTransform = function (v) {
      var createQuantity = function (v1) {
          ...
          throw new Error("Failed pattern match at Calculator.Model line 371, column 5 - line 371, column 51: " + [ v1.constructor.name ]);
      };
      ...
      return function (qty) {
          var appRatio = function (r) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 381, column 5 - line 381, column 47: " + [ r.constructor.name, v1.constructor.name ]);
              };
          };
  ...
  var foodSharing = function (v) {
      return function (v1) {
          ...
          var edibleShared = applyRatio(v.sharedFoodRatio)(edibleWasted);
          return State.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ new Entry({
              process: Eating.value, 
              matter: Food.value, 
              matterProperty: Edible.value, 
  ...
  var nexusSystem = function (v) {
      ...
      var endState = (function () {
          ...
          if (v.value0.current instanceof EatingBinningWormCompostingFoodGardening) {
              return managingWaste(v.value0.processParams.managedWasteParam)(binning(v.value0.processParams.binningParam)(foodGardening_EatingBinningWormCompostingFoodGardening(v.value0.processParams.foodGardeningParam)(composting_EatingBinningWormComposting(v.value0.processParams.wormCompostingParam)(eating(v.value0.processParams.eatingParam)(state$prime)))));
          };
          if (v.value0.current instanceof EatingBinningWormCompostingFoodGardenRainwater) {
              return managingWaste(v.value0.processParams.managedWasteParam)(binning(v.value0.processParams.binningParam)(foodGardening_EatingBinningWormCompostingFoodGardening(v.value0.processParams.foodGardeningParam)(rainwaterCollecting_EatingBinningWormCompostingFoodGardenRainwater(v.value0.processParams.rainwaterCollectingParam)(composting_EatingBinningWormComposting(v.value0.processParams.wormCompostingParam)(eating(v.value0.processParams.eatingParam)(state$prime))))));
          };
          ...
          if (v.value0.current instanceof EatingBinningWormCompostingFoodSharing) {
              return managingWaste(v.value0.processParams.managedWasteParam)(binning(v.value0.processParams.binningParam)(composting_EatingBinningWormComposting(v.value0.processParams.wormCompostingParam)(foodSharing(v.value0.processParams.foodSharingParam)(eating_EatingBinningWormCompostingFoodSharing(v.value0.processParams.eatingParam)(state$prime)))));
          };
          return new State([  ]);
      })();
      return SystemState.create((function () {
          var $454 = {};
          for (var $455 in v.value0) {
              if (v.value0.hasOwnProperty($455)) {
                  $454[$455] = v.value0[$455];
              };
          };
          $454.state = endState;
          return $454;
          ...
          return function (item) {
              ...
              var hoverClass = function (v) {
                  return function (v1) {
                      ...
                      throw new Error("Failed pattern match at Calculator.Layout line 54, column 1 - line 81, column 1: " + [ v.constructor.name, v1.constructor.name ]);
                  };
              };
  ...
  var arrayArrow = function (v) {
      ...
      if (v.value0.current instanceof Calculator_Model.EatingBinningWormCompostingFoodGardening) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              ...
              quantity: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(initialCompost(v.value0.state)), 
              details: "of Fertiliser"
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(2)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(6)(emptyArrow))(Data_Array.replicate(7)(emptyArrow)))))))))))))));
      };
      if (v.value0.current instanceof Calculator_Model.EatingBinningFoodSharing) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyArrow))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "_", 
...
(function(exports) {
  ...
  var timescaleToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 121, column 1 - line 122, column 1: " + [ v.constructor.name ]);
  };
  ...
  var scaleToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 117, column 1 - line 118, column 1: " + [ v.constructor.name ]);
  };
  ...
  var optionsLabel = function (v) {
      ...
      if (v instanceof Calculator_Model.EatingBinningWormCompostingFoodSharing) {
          return "Wormery & Food Sharing";
      };
      return "Not Implemented Yet";
  };
  var nexusOptions = Flare.select(Data_Foldable.foldableArray)("Options")(new Data_NonEmpty.NonEmpty(Calculator_Model.EatingOnly.value, [ Calculator_Model.EatingBinning.value, Calculator_Model.EatingBinningWormComposting.value, Calculator_Model.EatingBinningWormCompostingFoodGardening.value, Calculator_Model.EatingBinningWormCompostingFoodGardenWatering.value, Calculator_Model.EatingBinningWormCompostingFoodGardenRainwater.value, Calculator_Model.EatingBinningFoodSharing.value, Calculator_Model.EatingBinningWormCompostingFoodSharing.value ]))(optionsLabel);
