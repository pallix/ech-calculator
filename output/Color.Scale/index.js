...
var colors = function (v) {
    return function (v1) {
        ...
        return Control_Bind.bind(Data_List_Types.bindList)(Data_List.range(0)(v1 - 1))(function (v2) {
            return Control_Applicative.pure(Data_List_Types.applicativeList)(sample(v)(Data_Int.toNumber(v2) / Data_Int.toNumber(v1 - 1)));
        });
    };
};
