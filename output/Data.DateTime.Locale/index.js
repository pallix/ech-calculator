...
var ordLocale = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        var $97 = Data_Ord.compare(Data_Maybe.ordMaybe(ordLocaleName))(x.value0)(y.value0);
        if ($97 instanceof Data_Ordering.LT) {
            return Data_Ordering.LT.value;
        };
        if ($97 instanceof Data_Ordering.GT) {
...
var ordLocalValue = function (dictOrd) {
    return new Data_Ord.Ord(function () {
        ...
        return function (y) {
            var $110 = Data_Ord.compare(ordLocale)(x.value0)(y.value0);
            if ($110 instanceof Data_Ordering.LT) {
                return Data_Ordering.LT.value;
            };
