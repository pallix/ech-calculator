          ...
          return function (v) {
              return function (input) {
                  return function (v1) {
                      ...
                      if (v1 instanceof NotImplemented) {
                          return new State({
 ...
 */  
  ...
  var controllableParam = function (eatedFoodRatio) {
      var $11 = {};
      for (var $12 in Calculator_Model.flowParams) {
          if (Calculator_Model.flowParams.hasOwnProperty($12)) {
              $11[$12] = Calculator_Model.flowParams[$12];
          };
      };
      $11.eatingParam = (function () {
          var $8 = {};
          for (var $9 in eatingParam) {
              if (eatingParam.hasOwnProperty($9)) {
                  $8[$9] = eatingParam[$9];
              };
          };
          $8.eatedFoodRatio = new Calculator_Model.Ratio(Calculator_Model.AnyFood.value, {
 ...
 */  
  var ui = function (v) {
      ...
      return Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(Calculator_Layout["interface"])(Flare["boolean"]("Info")(true)))(Flare["boolean"]("Grid")(false)))(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(Calculator_Model.nexusSystem)(Control_Applicative.pure(Flare.applicativeUI)(Calculator_Model.PersonScale.value)))(Control_Applicative.pure(Flare.applicativeUI)(systemParam)))(Control_Applicative.pure(Flare.applicativeUI)(controllableParam(0.0))))(Control_Applicative.pure(Flare.applicativeUI)(eatingInitState)))(Control_Applicative.pure(Flare.applicativeUI)(Calculator_Model.NotImplemented.value)));
  };
  var inner = function ($15) {
      return Flare_Smolder.runFlareHTML("controls")("output")(ui($15));
  };
  var main = Flare.runFlareWith("select")(inner)(nexus);
  exports["Food"] = Food;
  exports["Bin"] = Bin;
