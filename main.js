 ...
 */  
  ...
  var mergeState = new Data_Semigroup.Semigroup(function (s1) {
      return function (s2) {
          return s1;
      };
  });                                                                  
          ...
          return function (v) {
              return function (v1) {
                  return function (input) {
                      if (v1 instanceof Eating) {
                          var eatingOutput = eating(v.eatingParam)(input);
                          return eatingOutput;
                      };
                      if (v1 instanceof EatingBinning) {
                          var eatingOutput = eating(v.eatingParam)(input);
                          var binningOutput = binning(v.binningParam)(eatingOutput);
                          var eatingBinningOutput = Data_Semigroup.append(mergeState)(eatingOutput)(binningOutput);
                          return eatingBinningOutput;
                      };
                      if (v1 instanceof Composting) {
                      ...
                      if (v1 instanceof CompostingGarden) {
                      ...
                      if (v1 instanceof CompostingFoodGarden) {
                      ...
                      if (v1 instanceof WateringGarden) {
                      ...
                      if (v1 instanceof RainwaterWateringGarden) {
                      ...
                      throw new Error("Failed pattern match at Calculator.Model line 327, column 1 - line 329, column 40: " + [ scale.constructor.name, systemP.constructor.name, v.constructor.name, v1.constructor.name, input.constructor.name ]);
                  };
              };
          };
      };
          ...
          return function (item) {
              ...
              var hoverClass = function (v) {
                  return function (v1) {
                      ...
                      throw new Error("Failed pattern match at Calculator.Layout line 46, column 1 - line 68, column 1: " + [ v.constructor.name, v1.constructor.name ]);
                  };
              };
      ...
      return function (grid) {
          return function (v) {
              var showConsumedFood = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Layout line 209, column 7 - line 210, column 7: " + [ v1.constructor.name ]);
              };
              var showAvailableFood = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Layout line 197, column 1 - line 214, column 51: " + [ v1.constructor.name ]);
              };
...
(function(exports) {
  ...
  var nexusSystemUI = Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(Calculator_Model.nexusSystem)(Flare.select(Data_Foldable.foldableArray)("Scale")(new Data_NonEmpty.NonEmpty(Calculator_Model.PersonScale.value, [ Calculator_Model.HouseholdScale.value, Calculator_Model.EstateScale.value ]))(scaleToString)))(Control_Applicative.pure(Flare.applicativeUI)(systemParam)))(Flare.fieldset("Eating Parameters")(Data_Functor.map(Flare.functorUI)(controllableParam)(Flare.numberSlider("eatedFoodRatio")(0.0)(1.0)(1.0e-2)(0.81)))))(options))(Control_Applicative.pure(Flare.applicativeUI)(eatingInitState));
  var ui = Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(Calculator_Layout["interface"])(Flare["boolean"]("Info")(true)))(Flare["boolean"]("Grid")(false)))(nexusSystemUI);
  ...
  exports["label"] = label;
  exports["main"] = main;
  exports["nexusSystemUI"] = nexusSystemUI;
