 ...
 */  
  ...
  var eatingParam = {
      ...
      edibleWasteRatio: new Ratio(Food.value, {
          ratio: 0.114
      }), 
      nonedibleFoodWasteRatio: new Ratio(Waste.value, {
          ratio: 7.6e-2
      })
  };
  var binningParam = {
  ...
  var eating = function (v) {
      return function (v1) {
          ...
          var wasted = applyTransform(v.allFoodWasteProcess)(shoppedFood);
          var consumed = applyRatio(v.eatedFoodRatio)(shoppedFood);
