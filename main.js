 ...
 */  
  ...
  var eating = function (v) {
      return function (v1) {
          return new State((function () {
              var $243 = {};
              for (var $244 in v1.value0) {
                  if (v1.value0.hasOwnProperty($244)) {
                      $243[$244] = v1.value0[$244];
                  };
              };
              $243.shoppedFood = applyRatio(v.eatedFoodRatio)(v1.value0.shoppedFood);
              $243.binnedFoodWaste = new Stock(new Weight(AnyWaste.value, 68.0), new Weight(AnyWaste.value, 2.0));
              return $243;
          })());
      };
  };
  ...
  var binning = function (v) {
      return function (v1) {
          return new State((function () {
              var $271 = {};
              for (var $272 in v1.value0) {
                  if (v1.value0.hasOwnProperty($272)) {
                      $271[$272] = v1.value0[$272];
                  };
              };
              $271.binnedFoodWaste = applyProcess(v.allFoodWasteProcess)(v1.value0.shoppedFood);
              return $271;
          })());
      };
  };
      ...
      return function (systemP) {
          return function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 454, column 1 - line 456, column 40: " + [ scale.constructor.name, systemP.constructor.name, v.constructor.name, v1.constructor.name ]);
              };
          };
      };
  };
