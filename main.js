...
(function(exports) {
  ...
  var CompostingOnly = (function () {
      function CompostingOnly() {

      };
      CompostingOnly.value = new CompostingOnly();
      return CompostingOnly;
  })();
  ...
  var GreyWatter = (function () {
      function GreyWatter() {

      };
      GreyWatter.value = new GreyWatter();
      return GreyWatter;
  })();
  ...
  var showQuantity = function (dictShow) {
      return new Data_Show.Show(function (v) {
          if (v instanceof Weight) {
              return "Weight: " + Data_Show.show(Data_Show.showNumber)(v.value1);
          };
          if (v instanceof Volume) {
              return "Volume: " + Data_Show.show(Data_Show.showNumber)(v.value1);
          };
          ...
          throw new Error("Failed pattern match at Calculator.Model line 186, column 5 - line 186, column 47: " + [ v.constructor.name ]);
      });
  };
  var processEq = new Data_Eq.Eq(function (a) {
      return function (b) {
          var $52 = [ a, b ];
          if ($52.length === 2 && ($52[0] instanceof Shopping && $52[1] instanceof Shopping)) {
              return true;
          };
          if ($52.length === 2 && ($52[0] instanceof Eating && $52[1] instanceof Eating)) {
              return true;
          };
          if ($52.length === 2 && ($52[0] instanceof Binning && $52[1] instanceof Binning)) {
              return true;
          };
          if ($52.length === 2 && $52[0] instanceof AllProcess) {
              return true;
          };
          if ($52.length === 2 && $52[1] instanceof AllProcess) {
              return true;
          };
          return false;
      };
  ...
  var neg = function (v) {
      if (v instanceof Weight) {
          return new Weight(v.value0, 0.2);
      };
      if (v instanceof Volume) {
          return new Volume(v.value0, 0.5);
      };
      if (v instanceof IncompatibleQuantity) {
      ...
      throw new Error("Failed pattern match at Calculator.Model line 80, column 1 - line 81, column 1: " + [ v.constructor.name ]);
  };
  ...
  var matterProperty = new Data_Eq.Eq(function (a) {
      return function (b) {
          var $78 = [ a, b ];
          if ($78.length === 2 && ($78[0] instanceof Edible && $78[1] instanceof Edible)) {
              return true;
          };
          if ($78.length === 2 && ($78[0] instanceof NonEdible && $78[1] instanceof NonEdible)) {
              return true;
          };
          if ($78.length === 2 && ($78[0] instanceof Shopped && $78[1] instanceof Shopped)) {
              return true;
          };
          if ($78.length === 2 && ($78[0] instanceof Cooked && $78[1] instanceof Cooked)) {
              return true;
          };
          if ($78.length === 2 && $78[0] instanceof AllMatterProperty) {
              return true;
          };
          if ($78.length === 2 && $78[1] instanceof AllMatterProperty) {
              return true;
          };
          return false;
      };
  ...
  var matterEq = new Data_Eq.Eq(function (a) {
      return function (b) {
          var $91 = [ a, b ];
          if ($91.length === 2 && ($91[0] instanceof Food && $91[1] instanceof Food)) {
              return true;
          };
          if ($91.length === 2 && ($91[0] instanceof Waste && $91[1] instanceof Waste)) {
              return true;
          };
          if ($91.length === 2 && $91[0] instanceof AllMatter) {
              return true;
          };
          if ($91.length === 2 && $91[1] instanceof AllMatter) {
              return true;
          };
          return false;
      };
  ...
  var genericMatter = new Data_Generic.Generic(function (v) {
      ...
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.ManagedWaste" && v.value1.length === 0)) {
          return new Data_Maybe.Just(ManagedWaste.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Calculator.Model.GreyWatter" && v.value1.length === 0)) {
          return new Data_Maybe.Just(GreyWatter.value);
      };
      ...
      return new Data_Generic.SigProd("Calculator.Model.Matter", [ {
          ...
          sigConstructor: "Calculator.Model.ManagedWaste", 
          sigValues: [  ]
      }, {
          sigConstructor: "Calculator.Model.GreyWatter", 
          sigValues: [  ]
      }, {
      ...
      if (v instanceof ManagedWaste) {
          return new Data_Generic.SProd("Calculator.Model.ManagedWaste", [  ]);
      };
      if (v instanceof GreyWatter) {
          return new Data_Generic.SProd("Calculator.Model.GreyWatter", [  ]);
      };
      if (v instanceof AllMatter) {
          return new Data_Generic.SProd("Calculator.Model.AllMatter", [  ]);
      };
      throw new Error("Failed pattern match at Calculator.Model line 111, column 1 - line 111, column 48: " + [ v.constructor.name ]);
  });
  ...
  var eatingParam = {
      ...
      allFoodWasteProcess: new Transform(Food.value, Waste.value, {
          ratio: 0.19
      }), 
      edibleWasteProcess: new Transform(Food.value, Waste.value, {
          ratio: 0.114
      }), 
      nonedibleFoodWasteProcess: new Transform(Food.value, Waste.value, {
          ratio: 7.6e-2
      })
  };
  var binningParam = {
      title: "Binning", 
      inputRatio: new Ratio(Waste.value, {
          ratio: 1.0
      }), 
      allFoodWasteProcess: new Transform(Food.value, Waste.value, {
          ratio: 0.19
  ...
  var applyTransform = function (v) {
      var createQuantity = function (v1) {
          ...
          throw new Error("Failed pattern match at Calculator.Model line 243, column 5 - line 243, column 51: " + [ v1.constructor.name ]);
      };
      ...
      return function (qty) {
          var appRatio = function (r) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 258, column 5 - line 258, column 47: " + [ r.constructor.name, v1.constructor.name ]);
              };
          };
  ...
  var eating = function (v) {
      return function (v1) {
          ...
          var nonedibleWasted = applyTransform(v.nonedibleFoodWasteProcess)(shoppedFood);
          var edibleWasted = applyTransform(v.edibleWasteProcess)(shoppedFood);
          var eated = applyRatio(v.eatedFoodRatio)(shoppedFood);
  ...
  exports["CompostingOnly"] = CompostingOnly;
...
(function(exports) {
  ...
  var foodWaste = Calculator_Model.foldState(Calculator_Model.Eating.value)(Calculator_Model.Waste.value)(Calculator_Model.AllMatterProperty.value);
  ...
  var arrayHex = function (v) {
      if (v.value0.current instanceof Calculator_Model.EatingOnly) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(10)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(9)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(10)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(2)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              ...
              title: "Managed Waste", 
              details: Data_Show.show(Calculator_Model.showQuantity(Calculator_Model.showMatter))(foodWaste(v.value0.state))
      ...
      if (v.value0.current instanceof Calculator_Model.CompostingOnly) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(10)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Composting", 
              details: ""
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(4)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(10)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(3)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Eating", 
              details: ""
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(1)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Binning", 
...
(function(exports) {
  ...
  var scaleToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 103, column 1 - line 104, column 1: " + [ v.constructor.name ]);
  };
  var optionsLabel = function (v) {
      ...
      if (v instanceof Calculator_Model.CompostingOnly) {
          return "Composting";
      };
  ...
  var initState = new Calculator_Model.State([ new Calculator_Model.Entry({
      ...
      quantity: new Calculator_Model.Weight(Calculator_Model.Food.value, 120.0)
  }), new Calculator_Model.Entry({
      process: Calculator_Model.Shopping.value, 
      matter: Calculator_Model.Food.value, 
      matterProperty: Calculator_Model.Shopped.value, 
      quantity: new Calculator_Model.Weight(Calculator_Model.Food.value, -20.0)
  }), new Calculator_Model.Entry({
      process: Calculator_Model.Eating.value, 
      matter: Calculator_Model.Waste.value, 
