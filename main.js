      ...
      return function (systemP) {
          return function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Model line 539, column 1 - line 541, column 40: " + [ scale.constructor.name, systemP.constructor.name, v.constructor.name, v1.constructor.name ]);
              };
          };
      };
  };
          ...
          return function (item) {
              ...
              var hoverClass = function (v) {
                  return function (v1) {
                      ...
                      throw new Error("Failed pattern match at Calculator.Layout line 51, column 1 - line 74, column 1: " + [ v.constructor.name, v1.constructor.name ]);
                  };
              };
      ...
      return function (available) {
          return function (consumed) {
              var showConsumed = function (v) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Layout line 101, column 7 - line 102, column 7: " + [ v.constructor.name ]);
              };
              var showAvailable = function (v) {
                  ...
                  throw new Error("Failed pattern match at Calculator.Layout line 99, column 1 - line 108, column 1: " + [ v.constructor.name ]);
              };
              return showAvailable(available) + (" " + showConsumed(consumed));
          };
      };
  };
 ...
 */  
  var arrayHex = function (v) {
      if (v.value0.value0 instanceof Calculator_Model.Eating) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(10)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(9)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(10)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(2)(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              ...
              title: "Eating", 
              details: displayState("Food: ")(v.value0.value1.value0.shoppedFood.value0)(v.value0.value1.value0.shoppedFood.value1)
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton(emptyHex))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.singleton({
              title: "Managed Waste", 
              details: "..."
      ...
      if (v.value0.value0 instanceof Calculator_Model.Composting) {
